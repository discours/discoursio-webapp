...
- Переработан API для генерации OG изображений - объединены обработчики в один файл Vercel function (`api/og.js`) 
- Оптимизированы мета-теги для SEO и расшаривания контента
- Добавлен тег og:logo для соответствия требованиям валидаторов OG
- Создан централизованный модуль openGraph для уменьшения дублирования кода и улучшения поддержки
