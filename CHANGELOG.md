...
- дополнительная оптимизация компонента CommentCard с разделением на подкомпоненты
- улучшена обработка ошибок при взаимодействии с API комментариев

### Исправлено
- исправлена проблема с исчезновением фокуса в редакторе комментариев
- улучшена производительность при рендеринге больших деревьев комментариев
...
### Изменено
- улучшена структура компонента CommentCard для лучшей читаемости
...
- исправлено отображение бейджа автора в комментариях
