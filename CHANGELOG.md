...
- ⚡ **Оптимизирована логика кеширования**: Заменен постоянно меняющийся timestamp на фиксированную версию кеша
- 🛡️ **Упрощена логика повторных попыток**: Сокращено количество попыток с 3 до 2 для быстрого fallback на заглушки
- 🔧 **Обновлен middleware.js**: Упрощена логика обработки параметров кеширования
...
#### Комплексная стратегия кеширования изображений
- 🖼️ Исправлена проблема с кешированием заглушек вместо изображений на Vercel
- 🔄 Добавлен параметр версии к URL изображений для предотвращения кеширования
- 🛡️ Добавлена обработка ошибок загрузки изображений с автоматической перезагрузкой
- ⚡ Оптимизирован Service Worker для правильной обработки CDN ресурсов
- 📝 Добавлен файл конфигурации vercel.json с настройками кеширования
- 🔁 Реализован скрипт принудительного обновления изображений на Vercel
- 🚫 Добавлен middleware.js для управления заголовками кеширования
- 🧹 Создан API-эндпоинт для периодической очистки кеша
- 🔄 Настроено автоматическое обновление кеша каждые 6 часов через cron-задачу
