...
### 🛠️ Service Worker (WIP)
- **Исправлена блокировка изображений**: Service Worker больше не блокирует загрузку при ошибках fetch
- **Fallback стратегии**: При сбоях Service Worker передаёт управление браузеру
- **Версия 1.0.5**: Обновлена для принудительного обновления
...
### 🚀 UX
- **Убран флаш фильтров**: Фильтры ленты теперь отображаются сразу без условной логики
