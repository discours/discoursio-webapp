...
import createShoutMutation from '~/graphql/mutation/core/draft-create'
import deleteShoutMutation from '~/graphql/mutation/core/draft-delete'
import updateShoutMutation from '~/graphql/mutation/core/draft-update'
